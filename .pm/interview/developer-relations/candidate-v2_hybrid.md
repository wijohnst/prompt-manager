...
---
*Hybrid: Sonnet base (winner on artifact embeddedness + placeholder behavior). "Route confusion patterns to the PM as problem statements, not solution proposals" from Opus.*
